...
public class Inmueble {
	...
	public String toString() {
		return "Inmueble M2 Const= " + meConst + ", M2 Terr=" + meTerr
				+ ", M2 Jardin=" + meJardin + ", Año de construcción= " + añoC + ", NumCasa= "
				+ numCasa + ", Propietario= " + nombreP + ", tipo de casa= " + tipoC
				+ ", alberca= " + alberca + ".";
	}
