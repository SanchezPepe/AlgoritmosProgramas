...
public class Menu {
	...
	/*MÉTODO QUE MUESTRA UN JDIALOG CON LA INFORMACIÓN DE UNA MATERIA */
	public static void imprimeInfo(String inf){
		JOptionPane.showMessageDialog(dialog, inf);
	}

	/*MÉTODO QUE MUESTRA UN JDIALOG QUE INDICA UNA CONFIRMACION Y QUE RECIBE UN STRING COMO MENSAJE DE CONFIRMACIÓN*/
	public static void mensajeConfirm(String mensaje){
		JOptionPane.showMessageDialog(dialog, mensaje);
	}
	
	/*MÉTODO QUE MUESTRA UN JDIALOG QUE INDICA UNA ADVERTENCIA Y QUE RECIBE UN STRING COMO MENSAJE DE ADVERTENCIA*/
	public static void mensajeAdv(String mensaje){
		JOptionPane.showMessageDialog(dialog, mensaje, " ", JOptionPane.WARNING_MESSAGE);
	}
	
	/*MÉTODO QUE MUESTRA UN JDIALOG QUE PREGUNTA AL USUARIO LA CLAVE DE LA MATERIA*/
	...
	/*MÉTODO QUE MUESTRA UN JDIALOG QUE PREGUNTA AL USUARIO EL PARCIAL DE LA CALIFICACIÓN A ELIMINAR*/
	...
	/*MÉTODO QUE MUESTRA UN JDIALOG QUE PREGUNTA AL USUARIO EL NOMBRE DE LA NUEVA MATERIA*/
	public static String preguntaText(String preg){
		String input = JOptionPane.showInputDialog(null, preg);
	    return input;
	}
	
	/*MÉTODO QUE MUESTRA UN JDIALOG QUE PREGUNTA AL USUARIO LA CALIFICACIÓN A GUARDAR*/
	 ...
	 * INFORMACION DE ACUERDO A LA OPCION ESCOGIDA POR EL USUARIO*/
